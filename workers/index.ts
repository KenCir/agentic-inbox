...
async function receiveEmail(event: { to: string; raw: ReadableStream; rawSize: number }, env: Env, _ctx: ExecutionContext) {
	...
	// Incoming mail is stored without triggering automatic AI reply drafts.
}
